---
name: "source-command-fixing-motion-performance"
description: "Fix animation performance issues."
---

# source-command-fixing-motion-performance

Use this skill when the user asks to run the migrated source command `fixing-motion-performance`.
