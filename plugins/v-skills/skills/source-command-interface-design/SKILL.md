---
name: "source-command-interface-design"
...
# source-command-interface-design

Use this skill when the user asks to run the migrated source command `interface-design`.
